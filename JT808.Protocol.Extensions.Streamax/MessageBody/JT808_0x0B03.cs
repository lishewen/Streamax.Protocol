...
namespace JT808.Protocol.Extensions.Streamax.MessageBody
{
    ...
    /// 进出定点信息上报
    /// </summary>
    public class JT808_0x0B03 : JT808Bodies, IJT808MessagePackFormatter<JT808_0x0B03>, IJT808Analyze
    {
        public override ushort MsgId => 0x0B03;

        public override string Description => "进出定点信息上报";
        /// <summary>
        /// 线路编号
        /// </summary>
        ...
        public JT808_0x0B03 Deserialize(ref JT808MessagePackReader reader, IJT808Config config)
        {
            JT808_0x0B03 value = new JT808_0x0B03();
            value.GprsId = reader.ReadUInt32();
            value.IOType = reader.ReadByte();
        ...
        public void Serialize(ref JT808MessagePackWriter writer, JT808_0x0B03 value, IJT808Config config)
        {
