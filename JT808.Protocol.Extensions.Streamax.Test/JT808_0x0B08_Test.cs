...
{
    public class JT808_0x0B08_Test
    {
        JT808Serializer JT808Serializer;
        public JT808_0x0B08_Test()
        {
        ...
        public void Json()
        {
            var json = JT808Serializer.Analyze("7e0b08001300000000079500790000000a66012009270609346f7e".ToHexBytes());
        }
    }
}
